package com.example.saudalmajed.inventoryapp;
...
import com.example.saudalmajed.inventoryapp.data.ProductContract.InventoryEntry;
import com.bumptech.glide.Glide;

import java.io.File;

import static com.example.saudalmajed.inventoryapp.R.drawable.ic_broken_image;
import static com.example.saudalmajed.inventoryapp.R.id.quantity;
...
public class ProductEditor extends AppCompatActivity implements
    ...
    private EditText mProductName, mProductDescription, mProductInventory, mItemSold, mProductPrice, mSupplier;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSupplier = (EditText) findViewById(R.id.supplier_editText);
    ...
    private void saveProduct() {
        ...
        if (TextUtils.isEmpty(nameString) || TextUtils.isEmpty(descriptionString)
              ...
              ||TextUtils.isEmpty(supplier)  || TextUtils.isEmpty(priceString) || mCurrentPhotoUri.equals("no images")) {
        ...
        values.put(InventoryEntry.COL_SUPPLIER,supplier);
