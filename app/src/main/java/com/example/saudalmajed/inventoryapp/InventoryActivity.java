...
import com.example.saudalmajed.inventoryapp.data.ProductDbHelper;

import java.util.Random;

import static com.example.saudalmajed.inventoryapp.data.ProductContract.InventoryEntry;
public class InventoryActivity extends AppCompatActivity implements
    ...
    private void insertNewRandomData() {
        ...
        values.put(InventoryEntry.COL_SUPPLIER,suplier);
